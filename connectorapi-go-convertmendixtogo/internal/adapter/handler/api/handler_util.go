...
func ValidateHeadersAndAuth(c *gin.Context, method string, path string, apiKeyRepo *utils.APIKeyRepository, logger *zap.SugaredLogger) *appError.AppError {
...
func ValidateHeadersAndAuthNonChannelandDeviceos(c *gin.Context, method string, path string, apiKeyRepo *utils.APIKeyRepository, logger *zap.SugaredLogger) *appError.AppError {
	headers := getAPIHeaders(c)
