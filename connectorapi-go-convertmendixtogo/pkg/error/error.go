...
var (
	...
	ErrAeonID           = &AppError{ErrorCode: "COM008", ErrorMessage: "Invalid User Reference / Invalid AEON ID."}
	...
	ErrConNotPass1      = &AppError{ErrorCode: "COM043", ErrorMessage: "Condition not passed(Customer Cannot Register)"}
	...
	ErrInvAppChannel  	= &AppError{ErrorCode: "APP002", ErrorMessage: "Invalid ApplyChannel"}
	...
	ErrInvAppNo2        = &AppError{ErrorCode: "CST011", ErrorMessage: "Invalid Application No."}
